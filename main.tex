...
\section{Graphics}
    ...
    With PDF\LaTeX{} *.pdf, *.jpg and *.png files can be included with \texttt{\bs includegraphics[options]\{image\}}. For floating graphics see \fullref{section:floating_environments}.
